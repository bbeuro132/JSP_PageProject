...
public class BoardDB {
    ...
    public void insertArticle(BoardData article) 
            throws Exception {
	...
	public List<BoardData> getArticles(int start, int end)
             throws Exception {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            if (rs.next()) {
                articleList = new ArrayList<BoardData>(end);
                do{
                  BoardData article= new BoardData();
	...
	public BoardData getArticle(int num)
            throws Exception {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        BoardData article=null;
        try {
            conn = getConnection();
    ...
    public BoardData updateGetArticle(int num)
          throws Exception {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public int updateArticle(BoardData article)
          throws Exception {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs= null;
